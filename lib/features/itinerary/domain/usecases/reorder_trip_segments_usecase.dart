...
/// Renumbers [segments] to 0..n-1 (preserving the given order) and writes the
/// whole list back in one batched call. Used for every insert/delete/reorder
/// mutation rather than shifting individual order_index values — simpler to
/// reason about and self-healing at this scale (a handful to a few dozen
/// segments per trip).
