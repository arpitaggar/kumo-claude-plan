...
final tripEmailAliasProvider =
    FutureProvider.family<TripEmailAlias, String>((ref, itineraryId) async {
  final result =
      await ref.watch(tripEmailAliasRepositoryProvider).getAlias(itineraryId);
  return result.fold(
