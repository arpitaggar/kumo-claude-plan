-- ============================================================
-- NOT USED. Archived here (2026-08-05, security audit SEC-019) as a
-- historical draft only — it defines an entirely different, disconnected
-- schema (its own users/trips/member_role enum) that has no relationship
-- to the real, deployed schema built incrementally via
-- docs/supabase_migrations/stage*.sql. It also only enables RLS on 9 of
-- the tables it defines, so it must never be executed against a real
-- database. Kept for historical reference only.
-- ============================================================
--
-- ============================================================
