...
void main() {
  test('exposes exactly two field types: select and generated', () {
    expect(CostFieldType.values, [CostFieldType.select, CostFieldType.generated]);
  });
  ...
  test('two fields with the same fields (including nested options) are equal', () {
    const options = [
      OrgCostFieldOption(id: 'opt-1', fieldId: 'field-1', value: 'Sales', code: 'SAL', sortOrder: 0),
    ];
